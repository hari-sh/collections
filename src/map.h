...
bst* bst_create(int, comparator compare);
bst_node* bst_new_node(void*, int);
void bst_push_util(bst_node** ,void*, int, comparator compare);
void bst_pop_util(bst_node**,void*, comparator compare);
void* bst_search_util(bst_node** ,void*, int, comparator compare);
...
void* bst_search_util(bst_node** node,void* data, int size, comparator compare)   {
	if(*node==NULL)   {
		return NULL;
	}
    else    {
